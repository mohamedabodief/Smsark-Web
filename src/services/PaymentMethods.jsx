...
const PaymentIcons = {
  Bank: <img src={bankLogo} alt="banck" style={{ width: 120, height: 120 }} />,
  ...
  return (
    <>
      ...
      <Grid item xs={12}>
        ...
        >
          <strong>تنويه هام:</strong> يرجى من العميل اختيار وسيلة الدفع الأنسب
          له، وسداد قيمة الباقة المختارة، ثم تجهيز صورة إيصال الدفع ليتم رفعها
          عند استكمال عملية الاشتراك في الباقة
        </Typography>
      </Grid>
    </>
  );
