...
//         state.status = "succeeded";
//         state.uid = action.payload;
//         state.type_of_user = action.payload.type_of_user; // Store user type from payload
//         state.type_of_organization = action.payload.type_of_organization;
//       })
//       .addCase(loginUser.rejected, (state, action) => {
//         state.status = "failed";
//         state.error = action.payload;
//         state.uid = null; // Clear UID on failed login
//         state.type_of_user = null; // Clear user type on failed login
//         state.type_of_organization = null;
//       })
//       .addCase(registerUser.pending, (state) => {
//         state.status = "loading";
