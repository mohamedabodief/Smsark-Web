...
// import React, { useState } from 'react';
// import { Box, Typography, Button, Grid, Alert, Card } from '@mui/material';
// import { Person, Business } from '@mui/icons-material';
...
//                 py: 4,
//                 borderRadius: '12px',
//                 backgroundColor: userType === 'client' ? '#6E00FE' : 'transparent',
//                 borderColor: userType === 'client' ? '#6E00FE' : '#ddd',
//                 '&:hover': {
//                   backgroundColor: userType === 'client' ? '#5A00D6' : '#f5f5f5',
//                   borderColor: '#6E00FE',
...
//                 py: 4,
//                 borderRadius: '12px',
//                 backgroundColor: userType === 'organization' ? '#6E00FE' : 'transparent',
//                 borderColor: userType === 'organization' ? '#6E00FE' : '#ddd',
//                 '&:hover': {
//                   backgroundColor: userType === 'organization' ? '#5A00D6' : '#f5f5f5',
//                   borderColor: '#6E00FE',
//                 },
//               }}
//               onClick={() => setUserType('organization')}
...
//         <Box sx={{ display: 'flex', gap: 2, mt: 3, mx: 2 }}>
//           <Button
//             fullWidth
//             variant="outlined"
//             onClick={onBack}
